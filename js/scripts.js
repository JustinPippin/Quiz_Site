...
(function() {
    ...
    function showResults() {
        ...
        {
            //Get the current answer container we're looking for at the loop
            var answerContainer = answerContainers[i];

            //String to find which input is checked for the curernt operation
            var selector = `input [name=question${i}]:checked`;
            
            //Try to find the selected answer in the container and print out the value
            var userAnswer =
            (answerContainer.querySelector(selector) ||{}).value; //If it can't find a selected input for a question, querySelector will give back null. If it does
        ...
        //Add text to the results of the container to show how many they got right
